...
{
    public class DersDbContextFactory : IDesignTimeDbContextFactory<DersDbContext>
    {
        public DersDbContext CreateDbContext(string[] args)
        {
            ...
            {
                builder = new DbContextOptionsBuilder<DersDbContext>();
                builder.UseSqlServer(baglantiSatiri);
            }
            return new DersDbContext(builder.Options as DbContextOptions<DersDbContext>);
        }
