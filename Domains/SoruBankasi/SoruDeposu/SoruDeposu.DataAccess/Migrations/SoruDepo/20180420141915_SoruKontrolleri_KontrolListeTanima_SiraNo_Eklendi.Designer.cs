...
namespace SoruDeposu.DataAccess.migrations.sorudepo
{
    ...
    [Migration("20180420141915_SoruKontrolleri_KontrolListeTanima_SiraNo_Eklendi")]
    partial class SoruKontrolleri_KontrolListeTanima_SiraNo_Eklendi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.KontrolDegerGrupTanim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("AcikUcluDeger");

                    b.Property<string>("DegerGrupAdi");

                    b.HasKey("Id");

                    b.ToTable("KontrolDegerGruplari","Soru");
                });

            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.KontrolDegerTanim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("KontrolDegerGrupTanimNo");

                    b.Property<int>("Puan");

                    b.HasKey("Id");

                    b.HasIndex("KontrolDegerGrupTanimNo");

                    b.ToTable("KontrolListeDegerTanimlari","Soru");
                });

            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.KontrolListeGrupTanim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("KontrolListeGruplari","Soru");
                });

            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.KontrolListeTanim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("KontrolListeGrupNo");

                    b.Property<int>("Sira");

                    b.HasKey("Id");

                    b.HasIndex("KontrolListeGrupNo");

                    b.ToTable("KontrolListeTanimlari","Soru");
                });
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.SoruKontrol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("KontrolListeTanimNo");

                    b.Property<int?>("KontrolListeTanimiId");

                    b.Property<int>("PersonelNo");

                    b.Property<bool>("SinavdaCikabilir");
                    ...
                    b.HasIndex("KontrolListeTanimiId");

                    b.HasIndex("PersonelNo");

                    b.HasIndex("SoruNo");

                    b.ToTable("SoruKontrolleri","Soru");
                });

            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.SoruKontrolDetay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("SoruKontrolNo");

                    b.Property<string>("Yorum");

                    b.HasKey("Id");

                    b.HasIndex("SoruKontrolNo");

                    b.ToTable("SoruKontrolDetaylari","Soru");
                });

            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.SoruTip", b =>
                {
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.SoruZorluk", b =>
                {
                    b.Property<int>("ZorlukId")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("ZorlukAdi");

                    b.HasKey("ZorlukId");

                    b.ToTable("SoruZorluklari","Soru");
                });
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.TekDogruluSoruSecenek", b =>
                {
                    ...
                    b.Property<bool?>("hemenElenebilir");
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.KontrolDegerTanim", b =>
                {
                    b.HasOne("SoruDeposu.DataAccess.Entities.KontrolDegerGrupTanim", "DegerGrubu")
                        .WithMany("DegerListesi")
                        .HasForeignKey("KontrolDegerGrupTanimNo")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.KontrolListeTanim", b =>
                {
                    b.HasOne("SoruDeposu.DataAccess.Entities.KontrolDegerGrupTanim", "DegerGrubu")
                        .WithMany("KontrolListesi")
                        .HasForeignKey("KontrolListeGrupNo")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SoruDeposu.DataAccess.Entities.KontrolListeGrupTanim", "Grubu")
                        .WithMany("Listeleri")
                        .HasForeignKey("KontrolListeGrupNo")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.Soru", b =>
                {
                    ...
                    b.HasOne("SoruDeposu.DataAccess.Entities.SoruTip", "SoruTipi")
                        .WithMany("Sorulari")
                        .HasForeignKey("SoruTipNo");

                    b.HasOne("SoruDeposu.DataAccess.Entities.SoruZorluk", "SoruZorluk")
                        .WithMany("Sorulari")
                        .HasForeignKey("SoruZorlukNo")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.SoruKontrol", b =>
                {
                    b.HasOne("SoruDeposu.DataAccess.Entities.KontrolListeTanim", "KontrolListeTanimi")
                        .WithMany()
                        .HasForeignKey("KontrolListeTanimiId");

                    b.HasOne("SoruDeposu.DataAccess.Entities.Personel", "PersonelBilgisi")
                        .WithMany("SoruKontrolleri")
                        .HasForeignKey("PersonelNo")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("SoruDeposu.DataAccess.Entities.SoruKontrolDetay", b =>
                {
                    b.HasOne("SoruDeposu.DataAccess.Entities.SoruKontrol", "KontrolBilgisi")
                        .WithMany("Detaylari")
                        .HasForeignKey("SoruKontrolNo")
                        .OnDelete(DeleteBehavior.Cascade);
                });
